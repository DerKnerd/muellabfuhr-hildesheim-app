...
class NextPickupsWidget : GlanceAppWidget() {
                            ...
                            Column {
                                ...
                                for ((streetId, date, isPostponed, type) in pickups) {
                                    ...
                                    Row(
                                        ...
                                        Image(
                                            androidx.glance.ImageProvider(trashCanIcon),
...
class NextPickupsWidgetReceiver : GlanceAppWidgetReceiver() {
    override val glanceAppWidget: GlanceAppWidget = NextPickupsWidget()
}
